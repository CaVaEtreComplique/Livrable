...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<gio2>.freeze, ["= 3.3.5"])
      ...
      s.add_runtime_dependency(%q<gdk3>.freeze, ["= 3.3.5"])
    else
      s.add_dependency(%q<gio2>.freeze, ["= 3.3.5"])
      s.add_dependency(%q<atk>.freeze, ["= 3.3.5"])
      s.add_dependency(%q<pango>.freeze, ["= 3.3.5"])
      s.add_dependency(%q<gdk_pixbuf2>.freeze, ["= 3.3.5"])
      s.add_dependency(%q<gdk3>.freeze, ["= 3.3.5"])
    end
  else
    s.add_dependency(%q<gio2>.freeze, ["= 3.3.5"])
    s.add_dependency(%q<atk>.freeze, ["= 3.3.5"])
