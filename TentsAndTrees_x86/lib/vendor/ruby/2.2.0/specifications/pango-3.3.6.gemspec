...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<cairo-gobject>.freeze, ["= 3.3.6"])
      s.add_runtime_dependency(%q<gobject-introspection>.freeze, ["= 3.3.6"])
    else
      s.add_dependency(%q<cairo-gobject>.freeze, ["= 3.3.6"])
      s.add_dependency(%q<gobject-introspection>.freeze, ["= 3.3.6"])
    end
  else
    s.add_dependency(%q<cairo-gobject>.freeze, ["= 3.3.6"])
    s.add_dependency(%q<gobject-introspection>.freeze, ["= 3.3.6"])
